...
export const metadata = {
  title: "Kingz Smoke Ringz BBQ - Premium BBQ Catering & Events",
  description: "Slow-smoked perfection with Alabama-Texas style BBQ. Premium brisket, ribs, gourmet catering, and BBQ supplies. Serving the community since 2014.",
};
                    ...
                    <div className="sidebar-info-contents">
                        <div className="content-inner">
                            ...
                            <div className="content-box">
                                <h4>About Kingz Smoke Ringz BBQ</h4>
                                <p>Premium slow-smoked BBQ with Alabama-Texas style perfection. From brisket to ribs, we've been serving the community since 2014.</p>
                                <a href="/about" className="theme-btn">About Us<i className="fas fa-long-arrow-alt-right"></i></a>
                            </div>
            ...
            <div className="auto-container clearfix">
                ...
                <div className="top-right pull-right">
                    <ul className="menu-right-content pull-left clearfix">
                        ...
                        <li className="cart-box"><a href="shop-1.html"><i className="flaticon-shopping-cart-1"></i><span>0</span></a></li>
